...
const staticRoutes = [
  ...
  {
    path: "/vernepleier-lonn-kalkulator",
    filePath: "src/app/vernepleier-lonn-kalkulator/page.tsx",
    priority: 0.8,
    changeFrequency: "monthly" as const,
  },
  {
  ...
  {
    path: "/minstelonn/minstelonn-elektriker",
    filePath: "src/app/minstelonn/minstelonn-elektriker/page.tsx",
    priority: 0.8,
    changeFrequency: "monthly" as const,
  },
  {
    path: "/minstelonn/minstelonn-renholder",
    filePath: "src/app/minstelonn/minstelonn-renholder/page.tsx",
    priority: 0.8,
    changeFrequency: "monthly" as const,
  },
  {
    path: "/minstelonn/minstelonn-butikkmedarbeider",
    filePath: "src/app/minstelonn/minstelonn-butikkmedarbeider/page.tsx",
    priority: 0.8,
    changeFrequency: "monthly" as const,
  },
  {
