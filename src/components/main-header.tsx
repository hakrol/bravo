  ...
  return (
    <header className="sticky top-0 z-50 bg-[#f4f7f1] px-5 py-3 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        >
          <span className="inline-flex w-fit shrink-0 items-center gap-2.5 rounded-full bg-[linear-gradient(90deg,#064e3b_0%,#166534_58%,#bbf7d0_100%)] px-3.5 py-1.5 text-[0.66rem] font-extrabold uppercase tracking-[0.15em] text-white shadow-[0_14px_34px_rgba(20,83,45,0.18)] sm:px-4">
