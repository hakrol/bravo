...
export {
  ...
  getApprenticeshipMedianSalaryOverview,
  getApprenticeshipSalaryDistribution,
  getApprenticeshipSalaryTimeSeries,
  getLatestAndPreviousYearApprenticeshipSalaryDatasets,
  getLatestAndPreviousYearOccupationMedianMonthlySalaryDatasets,
  getLatestApprenticeshipSalaryDataset,
  ...
  runTablePostQuery,
  searchTables,
  SSB_APPRENTICESHIP_SALARY_TABLE_ID,
  SSB_SALARY_TABLES,
